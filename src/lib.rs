use ansi_escape_codes::{
    ASCIIControlCode, BackgroundColor, BrightForegroundColor, BrightBackgroundColor, Color::*,
...
impl StylizedString {
    pub fn to_string(self) -> String {
        let mut params: Vec<SelectGraphicRenditionParameter> = 
            self.modifiers.into_iter().map(|modifier| 
                match modifier {
                    Modifier::Bold => {
                    ...
                    Modifier::Underline => {
                        SelectGraphicRenditionParameter::UnderlineParameter
                    }
                    _ => panic!()
                }
            ).collect();
        let foreground_color_param = 
            match self.color {
                Color::Black => {
                ...
                Color::Default => {
                    SelectGraphicRenditionParameter::DefaultForegroundColorParameter
                },
                Color::RGB(red, green, blue) => {
                    SelectGraphicRenditionParameter::SetForegroundColorParameter(
                        ForegroundColor::ForegroundColor(ansi_escape_codes::Color::RGB(red, green, blue))
                    )
                },
            };
        let background_color_param = 
            match self.background_color{
                ...
                Color::RGB(red, green, blue) => {
                    SelectGraphicRenditionParameter::SetBackgroundColorParameter(
                        BackgroundColor::BackgroundColor(ansi_escape_codes::Color::RGB(red, green, blue))
                    )
                },
                Color::Default => {
                    SelectGraphicRenditionParameter::DefaultBackgroundColorParameter
                },
            };
...
pub fn test() {
    let params1: Vec<SelectGraphicRenditionParameter> = vec![
        ...
        SelectGraphicRenditionParameter::SetForegroundColorParameter(
            ForegroundColor::ForegroundColor(Color256(44)),
        ),
        SelectGraphicRenditionParameter::SetBrightForegroundColorParameter(
            BrightForegroundColor::BrightBlueForeground,
        ),
        SelectGraphicRenditionParameter::SetBackgroundColorParameter(
            BackgroundColor::BackgroundColor(RGB(255, 0, 127)),
        ),
        SelectGraphicRenditionParameter::BoldParameter,
        SelectGraphicRenditionParameter::ItalicParameter,
    ];
